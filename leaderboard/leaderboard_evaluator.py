...
#from distutils.version import LooseVersion ### distutils Version classes are deprecated
...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            print('\n\n\nself.route_scenario._parked_ids: ', self.route_scenario._parked_ids)
            actor_list = self.world.get_actors()
            print('actor_list len: ', len(actor_list))
        ...
        try:
            ...
            ###### get_ros_version is defined in autonomous_agent class
            print('ROS1: ', getattr(agent_class_obj, 'get_ros_version')(), self._ros1_server)
            ...
            print('\n\nnot self.sensors: ', not self.sensors)
            if not self.sensors:
                self.sensors = self.agent_instance.sensors()
                print('sensor number: (I only select 2)', len(self.sensors))
